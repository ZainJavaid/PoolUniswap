...
const contractABI = require("../artifacts/contracts/Pooluniswapswap.sol/Pooluniswapswap.json").abi;

program
    .name("pooluniswapswap-cli")
    .description("CLI tool for Pooluniswapswap smart contract")
    .version("1.0.0");
